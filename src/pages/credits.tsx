    ...
    >
      <Grid.Container justify="center">
        <Grid xs={22} md={20} style={{ marginTop: "1rem" }}>
          ...
          <p>
            La mappatura del Parco (Luoghi, Itinerari, Reti Attive e Storie), il
            documentario URBANORURALE e la pagina internet che li ospita sono
            stati realizzati dall’associazione di promozione sociale Agritettura
            2.0 come partner del progetto&nbsp;
            <a
          ...
          <p>
            ...
            Giovani, Politiche giovanili, Creatività e Innovazione e Servizio
            ...
            giovani NEET, studenti universitari e professionisti under 40, e
            grazie alla collaborazione con operatori sociali ed economici del
            territorio.
          </p>
        </Grid>
        <Grid xs={22} md={20} style={{ marginTop: "1rem" }}>
        ...
        <Grid xs={22} md={10} style={{ marginTop: "1rem" }}>
          ...
          <ul>
            ...
            <li>
              <strong>Jammo Bros - Diego D’Ambrosio, Raffaele Iardino</strong>
              <span> (Regia)</span>
            </li>
            <li>
        ...
        <Grid xs={22} md={20} style={{ marginTop: "1rem" }}>
          ...
          <ul>
            ...
            <li>
              ...
              territoriale del Parco”, 2009
            </li>
            <li>
              Comune di Napoli, Direzione centrale pianificazione e gestione del
              territorio – sito Unesco, Servizio affari generali e controlli
              interni - Unità organizzativa sistema informativo territoriale –
              SIT
            </li>
            <li>
